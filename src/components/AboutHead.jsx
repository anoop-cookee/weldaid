...
import CarousalContainer from "./CarousalContainer.jsx";
  ...
  const pagination = {
    ...
    renderBullet: function (index, className) {
      return (
        '<div class="' +
        className +
        ' w-[24px] h-[8px] rounded-[8px] text-[#E7E7E7]"></div>'
      );
    },
  };
  ...
  return (
    <div>
      ...
      <div>
        ...
        <Container>
            <div className="max-w-[800px] mb-[-70px] absolute -top-20 sm:top-0 ">
            {/* pl-[1vw] lg:pl-[1.5vw] */}
                  ...
                  <div className="font-normal text-[15px] sm:text-[22px] lg:text-[32px] lg:leading-[38px] leading-[18px] sm:leading-[28px] text-[#4F4F4F]">
                    ...
                    satisfaction, we have grown to become a trusted partner in
                    the industry.
                  </div>
                  <div className="mt-[30px] lg:mt-[40px] z-1 container">
      ...
      <Container>
        ...
        <div
          className="bg-[#FFCC00] rounded-[40px] p-[16px] 
